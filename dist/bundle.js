...
const react_router_dom_1 = __webpack_require__(923);
...
const Puzzle1 = () => {
    ...
    react_1.default.useEffect(() => {
        ...
        dispatch(puzzNumberSlice_1.one());
    }, []);
...
const Puzzle2 = () => {
    ...
    react_1.default.useEffect(() => {
        ...
        dispatch(puzzNumberSlice_1.two());
    }, []);
    //getting localstorage variables for the puzzle cells.
    //localstorage must not be null nor '0'.
    const GetLocalStorage = () => {
...
const Puzzle3 = () => {
    ...
    react_1.default.useEffect(() => {
        ...
        dispatch(puzzNumberSlice_1.three());
    }, []);
    //getting localstorage variables for the puzzle cells.
    //localstorage must not be null nor '0'.
    const GetLocalStorage = () => {
...
const Puzzle4 = () => {
    ...
    react_1.default.useEffect(() => {
        ...
        dispatch(puzzNumberSlice_1.four());
    }, []);
    //getting localstorage variables for the puzzle cells.
...
const Puzzle5 = () => {
    ...
    react_1.default.useEffect(() => {
        ...
        dispatch(puzzNumberSlice_1.five());
    }, []);
    //getting localstorage variables for the puzzle cells.
    //localstorage must not read null nor '0'.
    const GetLocalStorage = () => {
...
var _a;
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.selectCount = exports.five = exports.four = exports.three = exports.two = exports.one = exports.decrement = exports.increment = exports.counterSlice = void 0;
const toolkit_1 = __webpack_require__(32);
...
const selectCount = (state) => state.puzzleNumber.value;
